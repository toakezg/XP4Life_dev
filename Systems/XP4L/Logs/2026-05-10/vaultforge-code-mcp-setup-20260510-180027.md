...
event_id: vaultforge-code-mcp-setup-20260510-180027
...
tags:
  ...
  - log
---
# Event vaultforge-code-mcp-setup-20260510-180027
...
- no widget UI
- scoped MCP tools only: read tools, manifest tools, `dry_run_create_doc`, and scoped `create_doc`
Current baseline:
```text
Local root: F:\servers\mcp
Local endpoint: http://127.0.0.1:8787/mcp
Mode: local-scoped-write
Tools: status, list_sources, search, fetch, read_project_manifest, list_project_manifests, dry_run_create_doc, create_doc
