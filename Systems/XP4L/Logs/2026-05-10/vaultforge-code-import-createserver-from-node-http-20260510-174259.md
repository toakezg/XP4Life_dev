...
event_id: vaultforge-code-import-createserver-from-node-http-20260510-174259
...
tags:
  ...
  - log
---
# Event vaultforge-code-import-createserver-from-node-http-20260510-174259
...
const mcpPath = "/mcp";
const toolNames = ["status", "list_sources", "search", "fetch", "read_project_manifest"];
const localEnv = readLocalEnv(path.join(workspaceRoot, ".env"));
