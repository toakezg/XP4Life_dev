...
event_id: vaultforge-code-mcp-setup-20260510-174158
timestamp: 2026-05-10T17:41:58+00:00
day: 2026-05-10
...
tags:
  ...
  - log
---
# Event vaultforge-code-mcp-setup-20260510-174158
...
- no widget UI
- only read-only `status`, `list_sources`, `search`, `fetch`, and `read_project_manifest`
Current baseline:
```text
Local root: F:\servers\mcp
Local endpoint: http://127.0.0.1:8787/mcp
Mode: local-read-only
Tools: status, list_sources, search, fetch, read_project_manifest
