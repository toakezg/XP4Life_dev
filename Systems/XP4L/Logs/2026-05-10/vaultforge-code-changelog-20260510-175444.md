...
event_id: vaultforge-code-changelog-20260510-175444
...
tags:
  ...
  - log
---
# Event vaultforge-code-changelog-20260510-175444
...
- On 2026-05-11, documented the current working MCP baseline: local root, local and Developer Mode endpoints, read-only mode, approved tools, next read-only tool direction, explicit security gates, and the...
