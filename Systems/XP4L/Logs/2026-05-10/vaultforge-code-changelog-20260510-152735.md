...
event_id: vaultforge-code-changelog-20260510-152735
...
tags:
  ...
  - log
---
# Event vaultforge-code-changelog-20260510-152735
...
- text: # CHANGELOG
## 2026-05-10
- On 2026-05-11, tightened `search` and `fetch` for connector compatibility, added `scripts\run-connector-smoke.ps1`, and verified local plus public smoke runs at `https://long-bananas-cough.loca.lt/mcp`.
...
- On 2026-05-11, implemented read-only `search` and `fetch`...
