...
event_id: vaultforge-code-mcp-tool-surface-20260510-152736
...
tags:
  ...
  - log
---
# Event vaultforge-code-mcp-tool-surface-20260510-152736
...
## Tool Naming Rules
Tool names should be short, explicit, and behavior-oriented.
Use:
- `status`
- `list_sources`
- `search`
...
- `dry_run_action`
Avoid:
- generic names like `run`, `do`, `manage`, or `execute`
- tools that hide write behavior behind read-sounding names
- broad filesys...
